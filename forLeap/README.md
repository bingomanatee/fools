#forLeap
> Visualization for frame of reference conversion for Leap Motion Controller.

[![Build Status](https://travis-ci.org/bingomanatee/forleap.svg?branch=master)](https://travis-ci.org/bingomanatee/forleap) [![Dependency Status](https://david-dm.org/bingomanatee/forleap.svg)](https://david-dm.org/bingomanatee/forleap) [![devDependency Status](https://david-dm.org/bingomanatee/forleap/dev-status.svg)](https://david-dm.org/bingomanatee/forleap#info=devDependencies)
...
## Release History
 * 2014-05-22   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)